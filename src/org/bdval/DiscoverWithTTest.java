 ...
 */
public class DiscoverWithTTest extends DAVMode {
    private static final Log LOG = LogFactory.getLog(DiscoverWithTTest.class);
    ...
    public void process(final DAVOptions options) {
        ...
        for (final ClassificationTask task : options.classificationTasks) {
            for (final GeneList geneList : options.geneLists) {
                ...
                try {
                    System.out.println("Discover markers with T-Test " + task);
